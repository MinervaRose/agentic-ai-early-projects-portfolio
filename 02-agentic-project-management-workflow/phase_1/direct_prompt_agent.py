...
# TODO: 1 - Import the DirectPromptAgent class from base_agents
...
print(
    "\nThis response was generated using the general built-in world knowledge of the LLM "
    "(gpt-3.5-turbo), without persona, memory, or external knowledge. "
    "The DirectPromptAgent simply forwards the prompt directly to the model."
)